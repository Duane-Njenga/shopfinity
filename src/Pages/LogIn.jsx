...
function LogIn() {
  ...
  return (
    ...
    className={`max-w-md mx-auto p-6 rounded-lg shadow-lg border border-gray-200 hover:scale-102 ${dark ? " border-gray-400 hover:shadow-2xl hover:shadow-gray-400":"border-black hover:shadow-2xl hover:shadow-gray-800"}`}>
      ...
      >
        <div className="space-y-2">
          <label 
          className={`block text-sm font-medium  ${dark ? "text-darkText" : "text-gray-700"}`}          
          >Email Address</label>
          <input 
            type="email" 
